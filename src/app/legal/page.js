      ...
      <div className="p-6 md:p-8 border-b border-gray-100 bg-gray-50/50 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 flex items-center">
            ...
            Terminos Legales, Privacidad y Normativa
          </h2>
          <p className="text-gray-500 mt-2 text-sm max-w-2xl">
            Marco normativo, políticas de manejo de datos y directrices operativas implementadas para el sistema de automatizacion de telecomunicaciones en Ciudad Guayana.
          </p>
        </div>
      ...
      <div className="p-6 md:p-8 space-y-8 text-gray-700">
        ...
        <div className="p-6 bg-blue-50/40 rounded-xl border border-blue-100 space-y-3">
          <h3 className="text-base font-bold text-blue-900 flex items-center">
            ...
            1. Fundamento Legal en la Legislacion Venezolana
          </h3>
          ...
          <ul className="list-disc list-inside text-sm space-y-1.5 text-gray-600 pl-2">
            <li><strong>Ley Organica de Telecomunicaciones:</strong> Regula la prestacion de servicios de telecomunicaciones, garantizando la eficiencia, calidad y los derechos de los usuarios en el acceso a la red de fibra óptica.</li>
            <li><strong>Ley Especial contra los Delitos Informáticos:</strong> Establece la protección integral de los sistemas que utilicen tecnologías de informacion, resguardando la confidencialidad de los datos almacenados en nuestras bases de datos PostgreSQL (Supabase).</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 space-y-2">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Los números telefonicos y registros conversacionales recolectados a través de las pasarelas de Telegram y WhatsApp son seudonimizados y almacenados en bases de datos relacionales cifradas. No se comercializan ni ceden datos personales a terceros bajo ninguna circunstancia.
            </p>
          </div>
          ...
          <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 space-y-2">
            <div className="flex items-center text-gray-900 font-bold text-sm">
              ...
              3. Uso Etico de Inteligencia Artificial
            </div>
            <p className="text-sm text-gray-600 leading-relaxed">
              Las consultas procesadas por Google Gemini (API) se limitan estrictamente a la extracción de intenciones, validación geoespacial de cobertura y soporte tecnico inicial, cumpliendo con estrictas políticas de minimización de datos personales identificables (PII).
            </p>
          </div>
        </div>
        ...
        <div className="p-6 bg-amber-50/50 rounded-xl border border-amber-200 space-y-3">
          <h3 className="text-base font-bold. text-amber-900 flex items-center">
            ...
            4. Directrices de Atencion al Cliente y Transparencia Operativa
          </h3>
          <p className="text-sm leading-relaxed text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
            ...
            <div className="bg-white p-4 rounded-lg border border-amber-100 shadow-sm">
              <span className="font-bold text-xs text-amber-800 uppercase block mb-1">Intervencion Humana</span>
